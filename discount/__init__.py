...
class VoucherType:
    ...
    CHOICES = [
        ...
        (CATEGORY, pgettext_lazy('Voucher: discount for', 'A category of products')),
...
class VoucherApplyToProduct:
    ...
    CHOICES = [
        (ONE_PRODUCT, pgettext_lazy('Voucher application', 'Apply to a single item')),
        (ALL_PRODUCTS, pgettext_lazy('Voucher application', 'Apply to all matching products'))]