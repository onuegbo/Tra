...
from .utils import add_variant_to_delivery_group
from etrans.utils import (deallocate_stock, decrease_stock, increase_stock)
...
def process_delivery_group(group, cart_lines, discounts=None):
    ...
    for line in cart_lines:
        add_variant_to_delivery_group(group, line.variant, line.get_quantity(), discounts, add_to_existing=False)
