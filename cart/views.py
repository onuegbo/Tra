...
from etrans.models import ProductVariant
...
from .utils import (check_product_availability_and_warn, get_cart_data, get_or_empty_db_cart)
...
def summary(request, cart):
    ...
    return render(request, 'cart/cart_dropdown.html', data)